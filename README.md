...
| <img src="[https://via.placeholder.com/200x120?text=ML+Model](https://github.com/Steadfastbubble/client_churn/blob/main/final_provider/download.png)" width="200" alt="ML Project"> | **Churn Prediction** <br> Modelo de Clasificación para detección de abandono de clientes. | ![Scikit-Learn](https://img.shields.io/badge/Scikit--Learn-F7931E?style=flat&logo=scikit-learn&logoColor=white) | [📂 Open Repo](https://github.com/Steadfastbubble/client_churn) |
